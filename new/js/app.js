(function($) {
    ...
    /*var infobox = new InfoBox({
        ...
        boxStyle: {
            ...
            background: "url('new/images/infobox-bg.png') no-repeat",
        ...
        $.each(props, function(i,prop) {
            ...
            var infoboxContent = '<div class="infoW">' +
                                    ...
                                    '<div class="infoButtons">' +
                                        ...
                                        '<a href="single.php?id=' + prop.ids + '" class="btn btn-sm btn-round btn-green viewInfo">View</a>' +
